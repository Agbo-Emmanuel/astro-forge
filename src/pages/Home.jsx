...
const Home = () => {
  ...
  return (
    <main className="w-full">
      ...
      {/* Services */}
      <section className="w-full px-6 md:px-20 pt-16 bg-gray-100 flex flex-col md:gap-10 gap-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-4 md:gap-10">
          {services.map((service, index) => (
            ...
            >
              <div className="w-full h-20 md:h-40 rounded-lg overflow-hidden">
                <img
                  src={service.img}
                  alt={service.title}
      ...
      {/* Why AstroForge */}
      <section className="w-full px-6 md:px-20 pt-16 bg-gray-100 flex flex-col md:gap-10 gap-6">
        <article className="flex flex-col items-center text-center md:gap-3 gap">
